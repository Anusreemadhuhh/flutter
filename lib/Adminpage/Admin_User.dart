...
import 'package:widgetsapk/Adminpage/Navigationpage.dart';
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            width: 150,
                            height: 150,
                            decoration: BoxDecoration(color: Colors.grey,borderRadius: BorderRadius.circular(100),image: DecorationImage(image: AssetImage('assets/girl.jpg'),)),
                          ),
                        ),
                        Center(
                            child: Text(
