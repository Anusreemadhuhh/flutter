...
import 'Minofoodpage2.dart';
import 'Minofoodpage3.dart';

class Mino_home extends StatefulWidget {
  const Mino_home({super.key});

  @override
  State<Mino_home> createState() => _Mino_homeState();
}

class _Mino_homeState extends State<Mino_home> {
  @override
