...
import 'Cocktail2.dart';

class Cocktail1 extends StatefulWidget {
  const Cocktail1({super.key});

  @override
  State<Cocktail1> createState() => _Cocktail1State();
}

class _Cocktail1State extends State<Cocktail1> {
  @override
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        image: AssetImage("assets/Cocktail2.jpeg"),
                        fit: BoxFit.cover)),
                child: Stack(
                  children: [
                    Padding(
